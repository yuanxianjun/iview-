    ...
    <div v-if="searchable && searchPlace === 'top'" class="search-con search-con-top">
      <Select v-model="searchKey" class="search-col">
        <Option
          ...
          v-if="item.key !== 'handle' && item.searchable == true"
        >{{ item.title }}</Option>
      </Select>
      <Input
      ...
      <Checkbox class="checkDiv" v-if="showCheck" :value="checked" @on-change="changeValue">是否有效</Checkbox>
    </div>
    <Table
      ref="tablesMain"
...
export default {
  ...
  methods: {
    // 查看是否选中
    changeValue(value) {
      this.$emit("on-change-state", value);
    },
